...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
    	...
    	{
            double slp = ((double) that.y - (double) y) / ((double) that.x - (double) x);
            if (slp == -0.0)
            {
            	return +0.0;
            }
	...
	private class PointComparator implements Comparator<Point>
	{
		...
		public int compare(Point arg0, Point arg1) 
		{
			...
			double resultArg0 = Point.this.slopeTo(arg0);
			double resultArg1 = Point.this.slopeTo(arg1);
			if (resultArg0 < resultArg1)
			{
				return -1;
			}
			else
...
//        Point p = new Point(477, 359);
//        Point q = new Point(341, 359);
//        
